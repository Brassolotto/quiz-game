question_data = [
    ...
    {"text": "Em West Virginia, EUA, se você acidentalmente atropelar um animal com seu carro, você pode levá-lo para casa para comer.", "answer": "True"},
    {"text": "Em Londres, Reino Unido, se você morrer na Casa do Parlamento, tem direito a um funeral de estado.", "answer": "False"},
    {"text": "É ilegal urinar no oceano em Portugal.", "answer": "True"},
    {"text": "Você pode levar uma vaca para descer escadas, mas não para subir.", "answer": "False"},
    ...
    {"text": "Algumas gramas de chocolate podem matar um cachorro pequeno.", "answer": "True"}
]
